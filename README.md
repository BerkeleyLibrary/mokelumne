...
| `MOKELUMNE_GOBI_INPUT_DIR` | Shared directory containing incoming GOBI `.ord` files | `MOKELUMNE_GOBI_INPUT_DIR="/opt/airflow/files/gobi/incoming"` |
...
| `MOKELUMNE_GOBI_SCHEDULE` | Cron schedule for scanning the GOBI input directory | `MOKELUMNE_GOBI_SCHEDULE="*/2 * * * *"` |
