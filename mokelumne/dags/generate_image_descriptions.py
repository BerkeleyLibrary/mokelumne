    ...
    def transform_results(batch_results: list[dict], prompt: dict[str, str]) -> list[dict]:
        ...
        for record in batch_results:
            processed_dict = {
                ...
                "9830_a-1": f"mokelumne-image-description|anthropic:{os.environ.get('AWS_MODEL_ID')}|mokelumne/{prompt['version']}",
                "983__d-1": datetime.now(timezone.utc).strftime("%Y-%m-%d"),
                "983__t-1": "520"
            }
